...
date
echo "Running exp3 VGG13 Variable (NO PIXEL): n_layers=$n_layers, seed=$seed"
...
date
echo "Training completed: VGG13 (no pixel) n_layers=$n_layers seed=$seed"
