...
number=$SGE_TASK_ID
paramfile="scripts/jobs_exp5_mnist_dim256.txt"
...
# ---------------------------------------------------------------------
# Format per line in jobs_exp5_mnist_dim256.txt:
...
date
echo "Running exp5 MLP Variable MNIST (dim=256): n_layers=$n_layers, seed=$seed, dataset=$dataset"
...
date
echo "Training completed: MLP n_layers=$n_layers seed=$seed dataset=$dataset (dim=256)"
