...
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp5_mlp_cifar10
#SBATCH --array=1-45
#SBATCH --output=logs/exp5_mlp_cifar10_%A_%a.out
#SBATCH --error=logs/exp5_mlp_cifar10_%A_%a.err
set -euo pipefail
...
paramfile="scripts/jobs_exp5_cifar10.txt"
...
# ---------------------------------------------------------------------
# Format per line in jobs_exp5_cifar10.txt:
...
date
echo "Running exp5 MLP Variable CIFAR-10: n_layers=$n_layers, seed=$seed, dataset=$dataset"
