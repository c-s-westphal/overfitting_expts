...
number=$SGE_TASK_ID
paramfile="scripts/jobs_exp4.txt"
...
# ---------------------------------------------------------------------
# Format per line in jobs_exp4.txt:
#   <n_layers> <seed>
...
date
echo "Running exp4 MLP Variable: n_layers=$n_layers, seed=$seed"

# ---------------------------------------------------------------------
# 5.  Run single experiment
# ---------------------------------------------------------------------
echo "Starting training..."
python3.9 -u experiments/exp4_single_run.py \
    --n_layers "$n_layers" \
    --mi_bits 2.5 \
    --seed "$seed" \
    --batch_size 128 \
