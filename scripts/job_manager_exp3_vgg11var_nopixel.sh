...
number=$SGE_TASK_ID
paramfile="scripts/jobs_exp3_vgg11var.txt"
...
# ---------------------------------------------------------------------
# Format per line in jobs_exp3_vgg11var.txt:
#   <n_layers> <seed>
...
date
echo "Running exp3 VGG11 Variable (NO PIXEL): n_layers=$n_layers, seed=$seed"
...
date
echo "Training completed: VGG11 (no pixel) n_layers=$n_layers seed=$seed"
