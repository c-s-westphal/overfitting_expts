...
number=$SGE_TASK_ID
paramfile="scripts/jobs_exp3_vgg16var.txt"
...
# ---------------------------------------------------------------------
# Format per line in jobs_exp3_vgg16var.txt:
#   <n_layers> <seed>
...
date
echo "Running exp3 VGG16 Variable (NO PIXEL): n_layers=$n_layers, seed=$seed"
...
date
echo "Training completed: VGG16 (no pixel) n_layers=$n_layers seed=$seed"
