...
date
echo "Running exp3 VGG19 Variable (NO PIXEL): n_layers=$n_layers, seed=$seed"
...
date
echo "Training completed: VGG19 (no pixel) n_layers=$n_layers seed=$seed"
