...
number=$SGE_TASK_ID
paramfile="scripts/jobs_noise_pixel_fixed_vgg.txt"
...
# ---------------------------------------------------------------------
# Format per line in jobs_noise_pixel_fixed_vgg.txt:
#   <depth> <seed>
...
date
echo "Running exp3 (fixed MI=2.5 bits, VGG): depth=$depth, seed=$seed"
